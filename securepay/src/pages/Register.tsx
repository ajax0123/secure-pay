    ...
    <div className="min-h-[80vh] flex items-center justify-center">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-black tracking-tighter uppercase italic">Identity Registration</h1>
          <p className="text-gray-500 font-mono text-xs mt-2 uppercase">Establish Secure Node Connection</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-[#151B3D] border border-white/5 p-8 rounded-3xl shadow-2xl space-y-6">
          ...
          <div className="text-center pt-4">
            <p className="text-xs text-gray-500 font-mono uppercase">
              Already Registered? <Link to="/login" className="text-[#00D4FF] hover:underline">Access Session</Link>
            </p>
          </div>
        </form>
      </div>
