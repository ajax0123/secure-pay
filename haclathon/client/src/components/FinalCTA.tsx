      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Button size="lg" className="bg-primary hover:bg-primary/90 h-14 px-10 text-lg" onClick={() => window.location.href = 'http://localhost:5173/signup'}>
              Create Account <ArrowRight className="ml-2 w-5 h-5" />
            </Button>
            <Button size="lg" variant="outline" className="h-14 px-10 text-lg border-border hover:bg-secondary" onClick={() => window.location.href = 'http://localhost:5173/login'}>
