      ...
      <div className="mx-auto flex max-w-[1400px]">
        ...
        <main className="w-full px-4 py-4 md:px-8 md:py-8">
          <header className="relative mb-6 flex items-center justify-center">
            <button className="absolute left-0 md:hidden" onClick={() => setMobileOpen(true)}>
              <Menu className="h-6 w-6" />
            </button>
            <h1 className="px-12 text-center text-lg font-semibold md:px-0 md:text-2xl">Secure Digital Wallet</h1>
            <button
              className="absolute right-0 rounded-lg border border-slate-600 px-3 py-2 text-sm"
              onClick={toggleTheme}
            >
